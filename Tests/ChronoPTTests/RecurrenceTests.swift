...
@Suite("ChronoPT.Recurrence")
struct RecurrenceTests {
    @Test("Repeating notes give the next time and how they repeat", arguments: [
        ("tirar o lixo toda terça às 20h", [2026, 9, 22], [20, 0], ChronoPT.Recurrence.weekly(on: [.tuesday])),
    ...
    @Test("Repeating every few days, weeks or months", arguments: [
        ("regar as plantas a cada 15 dias", [2026, 9, 21], ChronoPT.Recurrence.every(DateComponents(day: 15))),
